...
export class IelcapiService {
  ...
  private getHeaders(): HttpHeaders {
    ...
    private baseUrl = 'https://coreappi.azurewebsites.net/EnrollmentSessions';
...
GetExamInfos(): Observable<any> {
  return this.http.get<any>(`${this.EnrolledskillsUrl}/sessionid`, { headers: this.getHeaders() });
    ...
    //   return this.http.get<any>(url, { headers: this.getHeaders() });
    // }
//https://coreappi.azurewebsites.net/EnrollmentSessions/Dates/search/azure/teams
...
//     const url = `https://coreappi.azurewebsites.net/EnrollmentSessions/Times/search/${encodedSkill}/${encodedDateRange}`;
...
//   }
  //https://coreappi.azurewebsites.net/EventSchedulerUser/latest
...
// }
//-------------------------------------------------------------------------------------------------------EventSchedules
eventscheduleUrls='https://coreappi.azurewebsites.net/EventSchedules';
...
//   );
// }
//https://coreappi.azurewebsites.net/EventSchedulerTime/times/exclude/latest?selectedTime=06%3A30%20PM%20%E2%80%93%2008%3A00%20PM
//---------------------------------------------------------------------------------------EventSchedulerTime
...
//---------------------------------------------------------------------------------------CoOwners 
createeventtablesurl = 'https://coreappi.azurewebsites.net/AddNewTables/createeventtables';

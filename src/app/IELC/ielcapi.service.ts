import { EventScheduleModel } from './../event-schedule.model.model';
...
//---------------------------------------------------------------------------------------Events Alerts
eventschedulerUrl='https://ielc-coreapi.azurewebsites.net/';
...
//--------------------------------------------------------------
EventSchedulerUser = "https://ielc-coreapi.azurewebsites.net/";
...
eventscheduleUrl='https://ielc-coreapi.azurewebsites.net/';
 GetLatestEvent(): Observable<EventScheduleModel> {
    return this.http.get<EventScheduleModel>(`${this.eventscheduleUrl}/EventSchedulerUser/latest`, { headers: this.getHeaders() });
...
extratouser = "https://ielc-coreapi.azurewebsites.net/ExtraTousers";
